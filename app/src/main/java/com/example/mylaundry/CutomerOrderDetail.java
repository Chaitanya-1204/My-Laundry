...
public class CutomerOrderDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cutomer_order_detail);
        customerName = findViewById(R.id.order_customer_name);
        phoneNumber = findViewById(R.id.order_Customer_phone_number);

        shirt = findViewById(R.id.order_customer_shirt);
        pant = findViewById(R.id.order_customer_pant);
        bedSheet = findViewById(R.id.order_customer_bedsheet);
        extra = findViewById(R.id.order_customer_extra);
        itemcount = findViewById(R.id.order_customer_itemCount);
        price= findViewById(R.id.order_customer_price);

        Intent intent = getIntent();
        phone = intent.getStringExtra("phoneNumber");
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Customer-Active-Order").child(phone);
